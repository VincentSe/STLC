...
(* The power function : λb.λn. n b.
   It is a normal form and its application to churchNat b and churchNat n
   does beta-reduce to the power b^n. However it does not have the STLC type
   NatType -> NatType -> NatType, because if n is assumed to have NatType,
   then it cannot be applied to another NatType.
   ...
   like System F or Hindley-Milner. *)
