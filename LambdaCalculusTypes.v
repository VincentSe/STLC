...
Proof.
  ...
  - induction n. intros. discriminate H. intros. simpl.
    ...
    + rewrite map_map in H2. apply in_map_iff in H2. destruct H2, H2. subst h.
      ...
      destruct abs, H4. discriminate H4.
...
Proof.
  induction t.
  - intros. simpl. destruct (n =? v) eqn:des. exists 1. simpl.
...
Proof.
  ...
  - induction n. intros. destruct p. discriminate H. discriminate H1.
    ...
    + (* Reduce inside t *)
      ...
      apply betaReduce_Subst. exact H4. intro abs. rewrite incrFreeVars_freevars in abs.
      apply in_map_iff in abs. destruct abs, H3. discriminate H3.
    + (* Reduce inside u *)
